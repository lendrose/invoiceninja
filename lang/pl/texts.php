...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'payment_type_Credit Card' => 'Inna karta kredytowa',
    'payment_type_PayPal' => 'PayPal',
    ...
    'migrate_to_next_version' => 'Migracja do następnej wersji Invoice Ninja',
    'migrate_intro_text' => 'Pracujemy nad kolejną wersją Invoice Ninja. Kliknij przycisk poniżej, aby rozpocząć migrację.',
    ...
    'migration_went_wrong' => 'Ups, coś poszło nie tak! Przed rozpoczęciem migracji upewnij się, że masz skonfigurowaną instancję Invoice Ninja v5.',
    ...
    'welcome_to_invoice_ninja' => 'Witamy w Invoice Ninja',
    'optin' => 'Opt-In',
    'optout' => 'Rezygnacja',
    ...
    'application_settings_label' => 'Przechowujmy podstawowe informacje o Twoim Invoice Ninja!',
    ...
    'migration_api_secret_notice' => 'Parametr API_SECRET znajdziesz w pliku .env lub w Invoice Ninja v5. Jeśli brakuje właściwości, pozostaw pole puste.',
    ...
    'migration_already_completed_desc' => 'Wygląda na to, że migracja <b>:company</b> została już przeprowadzona do wersji V5 Invoice Ninja. Jeśli chcesz zacząć od nowa, możesz wymusić migrację, aby usunąć istniejące dane.',
    ...
    'nordigen_requisition_body' => 'Dostęp do danych z kont bankowych wygasł zgodnie z postanowieniami Umowy użytkownika końcowego.<br><br> Zaloguj się do Invoice Ninja i ponownie uwierzytelnij się w swoim banku, aby móc nadal otrzymywać transakcje.',
    ...
    'peppol_token_description' => 'Token jest kolejnym krokiem w zapewnieniu bezpiecznego wysyłania faktur. W przeciwieństwie do licencji white-label, token można wymieniać w dowolnym momencie, bez konieczności oczekiwania na wsparcie Invoice Ninja.',
    ...
    'enable_public_notifications_help' => 'Włącz powiadomienia w czasie rzeczywistym z Invoice Ninja.',
    'navigate' => 'Nawigować',
    ...
    'pro_plan_feature_2' => 'Usuń „Utworzone przez Invoice Ninja”',
