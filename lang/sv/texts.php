...
<br />Aktivera detta om din webbläsare automatiskt laddar hem PDF:erna.',
    ...
    'peppol_token_description' => 'Token används som ytterligare ett steg för att se till att fakturor skickas säkert. Till skillnad från white-label-licenser kan token roteras när som helst utan att behöva vänta på Invoice Ninja-support.',
    ...
    'enable_public_notifications_help' => 'Aktivera aviseringar i realtid från Invoice Ninja.',
    'navigate' => 'Navigera',
