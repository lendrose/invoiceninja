...
$lang = array(
    ...
    'payment_type_Credit Card' => 'Credit Card',
    'payment_type_PayPal' => 'PayPal',
    ...
    'migrate_to_next_version' => 'Migrar a la próxima versión de Invoice Ninja',
    'migrate_intro_text' => 'Hemos estado trabajando en la próxima versión de Invoice Ninja. Haga clic en el botón de abajo para iniciar la migración.',
    ...
    'migration_went_wrong' => '¡Huy! Algo salió mal! Asegúrese de haber configurado una instancia de Invoice Ninja v5 antes de iniciar la migración.',
    ...
    'migration_already_completed_desc' => 'Parece que ya migró <b>:company_name</b> a la versión V5 de Invoice Ninja. En caso de que desee comenzar de nuevo, puede forzar la migración para borrar los datos existentes.',
    ...
    'new_login_description' => 'Recientemente inició sesión en su cuenta de Invoice Ninja desde una nueva ubicación o dispositivo:<br><br> <b>IP:</b> :ip<br> <b>Hora:</b> :time<br> <b>Correo electrónico:</b> :email',
    ...
    'peppol_token_description' => 'El token se utiliza como un paso más para garantizar que las facturas se envíen de forma segura. A diferencia de las licencias de marca blanca, el token se puede rotar en cualquier momento sin necesidad de esperar al soporte de Invoice Ninja.',
    ...
    'enable_public_notifications_help' => 'Habilite las notificaciones en tiempo real de Invoice Ninja.',
